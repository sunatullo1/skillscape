...
<section className="grid grid-cols-1 md:grid-cols-3 gap-8 px-16 py-16 bg-gray-50">
  <Link href="/ai-chat">
    <div style={{cursor:"pointer"}} className="bg-white p-8 rounded-2xl shadow-sm text-center hover:shadow-md transition-all">
      <div className="text-4xl mb-4">🤖</div>
      <h3 className="text-xl font-bold mb-2">{t.feature1_title}</h3>
      <p className="text-gray-500 mb-4">{t.feature1_desc}</p>
      <span style={{color:"#2563eb", fontWeight:"600"}}>Try it →</span>
    </div>
  </Link>
  <Link href="/match">
    <div style={{cursor:"pointer"}} className="bg-white p-8 rounded-2xl shadow-sm text-center hover:shadow-md transition-all">
      ...
      <p className="text-gray-500 mb-4">{t.feature2_desc}</p>
      <span style={{color:"#16a34a", fontWeight:"600"}}>Try it →</span>
    </div>
  </Link>
  <Link href="/tutors">
    <div style={{cursor:"pointer"}} className="bg-white p-8 rounded-2xl shadow-sm text-center hover:shadow-md transition-all">
      ...
      <p className="text-gray-500 mb-4">{t.feature3_desc}</p>
      <span style={{color:"#9333ea", fontWeight:"600"}}>Try it →</span>
    </div>
  </Link>
</section>
